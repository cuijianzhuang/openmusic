...
- 多音源搜索：网易云音乐、QQ 音乐、汽水音乐等
- **账号与漫游**：网易、QQ、汽水统一支持扫码、手动 Cookie、账号状态展示与个性化漫游；无可用汽水账号时自动锁定汽水漫游
- **本机音质**：自选偏好；切换后当前曲继续播放，下一首起生效
- **音质能力**：网易、QQ、汽水统一接入；房间账号和共享会员池会按权益自动选择
- 多人实时同步播放、歌词滚动
...
音乐凭证安全：扫码会话由服务端托管，房间 Cookie 加密保存，Meting 强制校验 HTTPS 证书。
