...
export const GUIDE_STEPS: GuideStep[] = [
  {
    ...
    scope: 'home',
    title: '账户与游客身份',
    body: '登录：可使用邮箱、Linux Do、GitHub 或微信扫码，并在账户安全中绑定多个身份\n游客：无需注册，原有建房、进房和点歌功能保持可用；收藏与分类绑定当前游客身份保存在服务端，登录后会安全合并到账户并恢复跨设备收藏\n登录后可在首页打开“我的房间”，查看跨设备恢复的账户房间；匿名房间需持有原房主凭证才能认领',
    side: 'bottom',
  },
  {
    id: 'home-nickname',
  ...
  },
  {
    ...
    scope: 'room',
    title: '点歌入口',
    body: '搜索：搜歌名或粘贴歌单链接\n播放历史：找回播过的歌\n热榜歌单：浏览精选歌单\n音乐电台：按电台听歌\n我的收藏：收藏过的歌，可新建分类并为歌曲归类筛选；也可创建 8 位固定快照分享码，分享码会按站点设置自动失效，也可随时撤销\n导入歌单：粘贴链接整单导入\n分享：搜索结果里的分享按钮可把歌曲发成聊天音乐卡片',
    side: 'bottom',
  },
  {
    id: 'room-hot',
  ...
  },
  {
    ...
    scope: 'room',
    title: '播放队列',
    body: '待播列表：查看当前排队歌曲\n排序/切歌/清空：需房主/管理（或获授权控播）\n踩歌：达到人数会触发切歌\n收藏：心形收藏当前队列里的歌\n分享到聊天：分享音乐卡片并可附一句话；点封面直接在本机播放并覆盖房间音乐，再点一次暂停即回到房间播放',
    side: 'top',
  },
  {
    id: 'room-chat',
    scope: 'room',
    title: '聊天室',
    body: '聊天：支持表情与贴纸\n撤回：右键消息（手机长按）\n自己：2 分钟内可撤回\n房主/管理：可撤他人（不能撤房主/其他管理）\n禁言：房主/管理可开禁言管理\n音乐卡片：点封面即在本机播放（覆盖房间音乐，房间播放器不受影响），卡片内显示滚动歌词，进度条可拖动定位；再点封面暂停立刻回到房间播放，播完也会自动切回；卡片可直接收藏，未在队列的歌曲右侧可点「+」点歌',
    side: 'left',
  },
  {
    id: 'room-header',
